...
$imagePath = "C:\Users\Uma\.gemini\antigravity\brain\957911e1-f25e-4b5e-b1ac-8c56bee6e1b5\uploaded_media_1769242543821.png"

if (Test-Path $imagePath) {
    try {
        $image = [System.Drawing.Bitmap]::FromFile($imagePath)
        # Sample the center just to be safe, or 10,10.
