        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 text-white flex items-center justify-center shadow-lg shadow-rose-200">
                        <ClipboardCheck size={28} />
                    </div>
                    <div>
                        <h1 className="text-2xl font-display font-bold text-slate-900">Risk Analysis</h1>
                        <p className="text-sm text-slate-500 mt-0.5">Weekly check-in • Week {currentWeek}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="px-3 py-2 text-xs font-bold text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors"
                    >
                        Clear
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="bg-white rounded-xl p-4 border border-slate-100">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm font-bold text-center focus:ring-2 focus:ring-rose-200 focus:border-rose-300 transition-all"
                                        />
                                    ...
                                    <span className="text-[10px] text-slate-400 mt-1 block text-center">mmHg</span>
                                </div>
                                ...
                                <div className="bg-white rounded-xl p-4 border border-slate-100">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm font-bold text-center focus:ring-2 focus:ring-amber-200 focus:border-amber-300 transition-all"
                                    />
                                    <span className="text-[10px] text-slate-400 mt-1 block text-center">mg/dL</span>
                                </div>
                                ...
                                <div className="bg-white rounded-xl p-4 border border-slate-100">
                                        ...
                                        {[1, 2, 3, 4, 5].map((level) => (
                                            <button
                                                ...
                                                className={`w-9 h-9 rounded-xl text-sm font-bold transition-all ${formData.activityLevel === level
                                                    ...
                                                    : 'bg-slate-50 text-slate-400 border border-slate-200 hover:border-teal-200'
                                                    }`}
                                            >
                                                {level}
                                            </button>
                                    ...
                                    <span className="text-[10px] text-slate-400 mt-1 block text-center">1=sedentary, 5=very active</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className={`w-full py-4 rounded-2xl font-bold text-white flex items-center justify-center gap-2 transition-all shadow-lg ${justSubmitted
                                    ...
                                    : 'bg-gradient-to-r from-rose-500 to-rose-600 shadow-rose-200 hover:shadow-xl'
                                    }`}
                            >
                                {isSubmitting ? (
                                    <>
                ...
                <div className="space-y-6">
                        ...
                        <div className={`rounded-[2rem] p-6 border-2 ${riskDisplay.bgColor} ${riskDisplay.borderColor}`}>
                            ...
                            {latestAssessment.overallLevel === 'high' && (
                                <button
                                    ...
                                    className="w-full mt-4 py-3 bg-white border border-rose-200 text-rose-700 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-rose-50 transition-colors"
                                >
                                    <FileText size={16} />
                    ...
                    {latestAssessment && (
                        <div className="bg-gradient-to-br from-purple-50 to-rose-50 rounded-2xl p-5 border border-purple-100 shadow-sm">
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-2">
                                    <Sparkles size={16} className="text-purple-500" />
                                    <span className="font-bold text-slate-700 text-sm">AI Insight</span>
                                    <span className="text-[9px] font-bold text-purple-500 bg-purple-100 px-2 py-0.5 rounded-full">GEMINI</span>
                                </div>
                                <button
                                    onClick={generateAIInsight}
                                    disabled={isLoadingInsight}
                                    className="text-xs text-purple-500 hover:text-purple-700 font-bold flex items-center gap-1"
                                >
                                ...
                                <div className="space-y-3">
                                    ...
                                    {selfCareTip && (
                                        <div className="bg-white/60 rounded-xl p-3 border border-purple-100">
                                            <span className="text-[10px] font-bold text-purple-500 uppercase tracking-wide mb-1 block">
                                                💜 Self-Care Tip
                                            </span>
                    ...
                    {showDoctorSummary && (
                        <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-lg">
                            ...
                            <pre className="text-xs text-slate-600 whitespace-pre-wrap bg-slate-50 p-4 rounded-xl overflow-auto max-h-64">
                                {getDoctorSummary()}
                            </pre>
                    ...
                    {latestAssessment && (
                        <div className="space-y-3">
                            <h3 className="font-bold text-slate-900 text-sm">Detailed Analysis</h3>
                    ...
                    {!latestAssessment && (
                        <div className="bg-slate-50 rounded-2xl p-8 text-center">
                            ...
                            <h3 className="font-bold text-slate-700 mb-2">No Check-In Yet</h3>
